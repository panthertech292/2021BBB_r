...
public class ShooterFireGatedLine extends CommandBase {
  private final ShooterSubsystem ShooterSubsystem;
  private final GateSubsystem GateSubsystem; 
  
  /** Creates a new ShooterFireGatedLine. */
  public ShooterFireGatedLine(ShooterSubsystem s_ShooterSubsystem, GateSubsystem s_GateSubsystem) {
  ...
  @Override
  public void execute() {
    ShooterSubsystem.changeSetSpeed((ShooterConstants.kShooterLine));
  ...
  public boolean isFinished() {
    return ShooterSubsystem.getTimerValue()>4.3;
  }
}
